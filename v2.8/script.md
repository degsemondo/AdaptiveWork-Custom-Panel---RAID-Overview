...
function exportHeatStyle(value) {
  var map = {
    'heatmap-rag-green': 'hmRagGreen', 'heatmap-rag-yellow': 'hmRagYellow',
    'heatmap-rag-amber': 'hmRagAmber', 'heatmap-rag-red': 'hmRagRed',
...
function workbookStyles() {
  ...
  return '<Styles>' +
    ...
    heat('hmRagGreen', '#2E7D32') + heat('hmRagYellow', '#C9A000') + heat('hmRagAmber', '#E67E00') + heat('hmRagRed', '#C62828') +
...
function importFromExcel(file) {
  ...
  reader.onload = function () {
    ...
    catch (e) { showToast('Could not read the file: ' + e.message, { error: true }); return; }
    processImport(book);
  };
