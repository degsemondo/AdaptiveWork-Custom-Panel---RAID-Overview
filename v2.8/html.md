...
<div class="aw-panel">
  ...
  <div class="aw-header">
    ...
    <button class="aw-btn" id="btn-expand-all" aria-label="Expand all action items">
      <i class="ti ti-chevrons-down" style="font-size:14px" aria-hidden="true"></i>
      <span class="expand-all-label">Expand all</span>
    </button>

    <input type="file" id="aw-import-file" accept=".xlsx,.xls,.xml" style="display:none" />
